...
var tabla_seccion = () => {
    ...
    $.ajax({
        type: 'GET',
        url: "{{ route('conductor.tablas.tb_index') }}", // Ruta que devuelve la vista en HTML
        data: {},
        beforeSend: function () {
...
var btnAddConductor = () => {
    ...
    $.ajax({
        type:'post',
        url: "{{ route('conductor.modals.md_crea_conductor') }}",
        dataType: "json",
...
var btnStoreConductor = () => {
    ...
    $.ajax({
        ...
        dataType: "json",
        cache: false,
        url: "{{ route('conductor.store_conductor') }}",
        data: formData,
        processData: false,
        contentType: false,
        beforeSend: function () {
        ...
        <div id="kt_content_container" class=" container-xxl ">
            <div class="card card-bordered bordered-success ">
                <div class="card-header">
                    <h3 class="card-title">LISTA DE CONDUCTORES AUTORIZADOS PARA EL SERVICIO PUBLICO Y PRIVADO - HUANCAVELICA</h3>
                    <div class="card-toolbar">
                        <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#large-Modal" onclick="btnAddConductor()">
                            Registrar Nuevo
                        </button>
                    </div>
                </div>
