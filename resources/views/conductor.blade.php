...
@section('main')
    <div id="error"></div>
    <h3><center>Ingrese el número de identificación del conductor</center></h3>
    <div class="busqueda">
        <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">N° de conductor</label>
            <input type="text" class="form-control" id="dni" name="dni" >
        </div>
        <div class="d-grid gap-2">
            <button class="btn btn-primary" type="button" onclick="btnBuscarDNI()">Buscar</button>
...
var btnBuscarDNI = () =>{
    ...
    $.ajax({
        ...
        success: function(response){
            ...
            {
                var id = response.data.idpersona;

                var URLd = "{{ route('view_conductor', ':id') }}".replace(':id', id);
