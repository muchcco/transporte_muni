<table class="table table-bordered table-striped table-hover" id="table_conductor">
    <thead class="bg-dark" > 
        <tr>
            ...
            <th class="text-white">Nombre del usuario</th>
        ...
        @foreach ($usuarios as $i => $usuario)
            <tr>
                ...
                <th>
                    @if ($usuario->flag == '1')
                        activo                        
                    @elseif($usuario->flag == '2')
                        inactivo
                    @endif
                </th>
                <th>
                    <div class="d-flex justify-content-center flex-shrink-0">
                        <button class="btn btn-sm bandejTool" data-tippy-content="Cambiar de Contraseña" onclick="btnEditPassUsuario('{{ $usuario->id }}')">
                        ...
                        <button class="btn btn-sm bandejTool" data-tippy-content="Editar usuario" onclick="btnEditUsuario('{{ $usuario->id }}')">
                        ...
                        <button class="btn btn-sm bandejTool" data-tippy-content="Eliminar empresa" onclick="EliminarUsuario('{{ $usuario->id }}')">
