...
@section('main')
    <h3 class="mb-3"><center>Datos del Vehiculo {{ $data->n_placa }} </center></h3>
    <div class="resultado">
        <table class="table table-bordered table-hover">
            ...
            <tr>
                <th>Ruta</th>
                <td>{{ $data->origen }} - {{ $data->destino }} </td>
            </tr>
            <tr>
                <th>Tipologia</th>
                <td>
            ...
            <tr>
                ...
                <td>{{ $data->año_fabricacion }}</td>
            </tr>
            <tr>
                <th>SOAT</th>
                <td>
                    @if ($soat >= '1')
                        <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><style>svg{fill:#2bae29}</style><path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM369 209L241 337c-9.4 9.4-24.6 9.4-33.9 0l-64-64c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.4 33.9 0l47 47L335 175c9.4-9.4 24.6-9.4 33.9 0s9.4 24.6 0 33.9z"/></svg>
                        Si cuenta
                    @else
                        <svg id="no-cuenta" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><style>#no-cuenta{fill:#b6170c}</style><path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM175 175c9.4-9.4 24.6-9.4 33.9 0l47 47 47-47c9.4-9.4 24.6-9.4 33.9 0s9.4 24.6 0 33.9l-47 47 47 47c9.4 9.4 9.4 24.6 0 33.9s-24.6 9.4-33.9 0l-47-47-47 47c-9.4 9.4-24.6 9.4-33.9 0s-9.4-24.6 0-33.9l47-47-47-47c-9.4-9.4-9.4-24.6 0-33.9z"/></svg>
                        No hay SOAT registrado
                    @endif
                </td>
            </tr>
            <tr>
            ...
            {{-- <tr>
                <th>Constatación de Características</th>
                <td>
                    @if ($caract >= '1')
                        <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><style>svg{fill:#2bae29}</style><path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM369 209L241 337c-9.4 9.4-24.6 9.4-33.9 0l-64-64c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.4 33.9 0l47 47L335 175c9.4-9.4 24.6-9.4 33.9 0s9.4 24.6 0 33.9z"/></svg>
                        Si cuenta
        ...
        <div class="d-grid gap-2">
            <a href="{{ route('vehiculo') }}" class="btn btn-primary" type="button" >Seguir buscando por placa</a>
