            ...
            <tr>
                ...
                <th>
                    <div class="d-flex justify-content-center flex-shrink-0">
                        <button class="btn btn-sm bandejTool" data-tippy-content="Editar Marca" onclick="btnEditMarca('{{ $m->idtipo_vehiculo }}')">
                        ...
                        <button class="btn btn-sm bandejTool" data-tippy-content="Eliminar Marca" onclick="EliminarMarca('{{ $m->idtipo_vehiculo }}')">
