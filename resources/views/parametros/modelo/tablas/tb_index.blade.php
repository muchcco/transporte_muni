            ...
            <tr>
                ...
                <th>
                    <div class="d-flex justify-content-center flex-shrink-0">
                        <button class="btn btn-sm bandejTool" data-tippy-content="Editar Modelo" onclick="btnEditModelo('{{ $m->idsubtipo_vehiculo }}')">
                        ...
                        <button class="btn btn-sm bandejTool" data-tippy-content="Eliminar Modelo" onclick="EliminarModelo('{{ $m->idsubtipo_vehiculo }}')">
