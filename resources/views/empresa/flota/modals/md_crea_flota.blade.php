<div class="modal-dialog modal-xl" role="document" style="max-width:70%">
    <div class="modal-content" >
        <div class="modal-header">
            <h4 class="modal-title">ASIGNAR NUEVA FLOTA</h4>
             <!--begin::Close-->
                ...
                <div id="seccion_personales" class="">
                    ...
                    <div class="row g-7 mb-6">
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" class="form-control form-control-solid " id="dni" name="dni" />
                    ...
                    <div class="row g-7 mb-6">
                        <div class="col-md-4 fv-row">
                            ...
                            <input type="text" class="form-control form-control-solid" id="nombre" name="nombre" oninput="convertirAMayusculas(this)">
                        </div>
                        <div class="col-md-4 fv-row">
                            <label class="required fs-6 fw-bold mb-2">Apellido Paterno</label>
                            <input type="text" class="form-control form-control-solid" id="ape_pat" name="ape_pat"  oninput="convertirAMayusculas(this)">
                        </div>
                        <div class="col-md-4 fv-row">
                            <label class="required fs-6 fw-bold mb-2 " id="ape_mat_class">Apellido Materno</label>
                            <input type="text" class="form-control form-control-solid"  id="ape_mat" name="ape_mat"  oninput="convertirAMayusculas(this)">
                        </div>
                    </div>
                    ...
                    <div class="row g-7 mb-6">
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <input type="text" class="form-control form-control-solid" id="direccion" name="direccion" oninput="convertirAMayusculas(this)">
                        </div>
                        <div class="col-md-4 fv-row">
                            <label class="required fs-6 fw-bold mb-2 ">Dirección de Referencia</label>
                            <input type="text" class="form-control form-control-solid"  id="dir_referencia" name="dir_referencia" oninput="convertirAMayusculas(this)">
                        </div>
                    </div>
                    <div class="row g-7 mb-6">
                        <div class="col-md-4 fv-row">
                            <label class="required fs-6 fw-bold mb-2">Teléfono</label>
                            <input type="text" class="form-control form-control-solid" id="celular" name="celular" >
                        </div>
                        <div class="col-md-4 fv-row">
        ...
        <div class="modal-footer">
            ...
            <button type="button" class="btn btn-light-success" id="btnEnviarForm" onclick="btnStoreFlota()">Guardar</button>
        </div>
    </div>
</div>
